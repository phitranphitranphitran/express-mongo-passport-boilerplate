...
describe("User Controller", () => {
  ...
  describe("POST /login", () => {
    ...
    afterEach(() => {
      // resets login cookies after every test
  ...
  describe("Already logged-in user features", () => {
    ...
    describe("Account change requests", () => {
  ...
  describe("POST /signup", () => {
    ...
    describe("Successful signup", () => {
      ...
      it("should make and set picture to gravatar", () => {
        expect(newUser.profile.picture).to.contain("gravatar");
      });
